...
namespace WebEjemplo
{
    ...
    //    //abrir una hoja ce calculo en estream

    //    static void Main(string[] args)
    //    {
    //        FileStream fs = new FileStream("miexcel.xlsx", FileMode.Open);

    //        MemoryStream msFirstPass = new MemoryStream();
    //        SLDocument slFirstPass = new SLDocument(fs, "Hoja1");
    //        slFirstPass.SetCellValue(5, 1, "Got the baton!");
    //        slFirstPass.SaveAs(msFirstPass);



    //        slFirstPass.SaveAs("OpenFromStreamModified.xlsx");
    ...
    //    internal LogicaExcel(DataRowBuilder builder)
    //        : base(builder)
    //    {
    //        this.id = 0;
    ...
    //        public LogicaExcel CreateNewRow()
    //        {
    //            return (LogicaExcel)NewRow();
    //        }

    //        protected override Type GetRowType()
    //        {
    //            return typeof(LogicaExcel);
    //        }

    //        protected override DataRow NewRowFromBuilder(DataRowBuilder builder)
    //        {
    //            return new LogicaExcel(builder);
    //        }
    //    }
